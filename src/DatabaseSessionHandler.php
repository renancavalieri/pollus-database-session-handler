...
use PDO;
use Pollus\DatabaseSessionHandler\Adapters\DatabaseAdapterInterface;
use \SessionHandlerInterface;
use \SessionIdInterface;
use \SessionUpdateTimestampHandlerInterface;
use Pollus\DatabaseSessionHandler\DatabaseSessionHandlerException;
...
implements SessionHandlerInterface, SessionIdInterface, SessionUpdateTimestampHandlerInterface
{
    ...
    public function __construct(DatabaseAdapterInterface $adapter) 
    {
        ...
        {
            throw new DatabaseSessionHandlerException("random_bytes() function doesn't exists");
        }
    }
